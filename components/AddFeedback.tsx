...
export default function AddFeedback({userId , productId} : {userId : number | undefined , productId : number}) {
  ...
  return (
    <div>
      <Dialog>
        <DialogTrigger className="border-2 border-amber-500 text-amber-600 hover:bg-amber-50 dark:hover:bg-amber-900/20 font-semibold px-3 py-2 md:px-6 md:py-3 rounded-xl transition duration-200">
          Write Review
        </DialogTrigger>
        <DialogContent>
          <DialogHeader>
