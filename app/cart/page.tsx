        ...
        <div className="w-full min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
            ...
            <div className="container mx-auto px-4 py-8 max-w-6xl">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-8">
                    <div>
                        <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white">Your Cart</h1>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 shadow-lg border border-amber-100 dark:border-gray-700 w-full lg:w-1/4">
                        <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">📍 Delivery Address</p>
                ...
                {cartItems.length === 0 ? (
                    ...
                    <div className="space-y-6">
                        {cartItems.map((cart, i) => (
                            <div key={i} className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-amber-100 dark:border-gray-700 hover:shadow-xl transition duration-300">
                                <div className="flex flex-col lg:flex-row gap-6">
                                    {/* Product Image & Info */}
                                    <Link href={`/product/${cart.product.id}`} className="flex flex-col sm:flex-row gap-4 flex-1 group">
                                        ...
                                        <div className="flex-1 space-y-3">
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className={`text-sm ${cart.product.quantity > 0 ? " text-green-600 dark:text-green-400 bg-green-100 dark:bg-green-900 " : " text-red-600 dark:text-red-400 bg-red-100 dark:bg-red-900 "} px-3 py-1 rounded-full font-medium`}>
                                    ...
                                    <div className="flex flex-col gap-3 lg:min-w-[160px] lg:items-end">
                                        <div className="bg-amber-50 dark:bg-amber-900/20 p-3 rounded-xl">
                                            <p className="text-sm text-amber-800 dark:text-amber-200 font-medium mb-2">Quantity</p>
                                            <CartQuantity min={1} max={cart.product.quantity} cartQuantity={cart.quantity}/>
                                        </div>
                                        
                                        <div className="flex flex-col gap-2 w-full">
                                            <BuyNow bookId={cart.product.id}/>
